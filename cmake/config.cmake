...
if(SC_HAVE_QSORT_R)
  if(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    set(SC_HAVE_GNU_QSORT_R ${SC_HAVE_QSORT_R})
    if(SC_HAVE_GNU_QSORT_R)
      check_symbol_exists(SC_HAVE_GNU_QSORT_R ${PROJECT_BINARY_DIR}/include/sc_config.h SC_have_gnu_qsort_r)
    endif()
  endif()
  if(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    set(SC_HAVE_BSD_QSORT_R ${SC_HAVE_QSORT_R})
    if(SC_HAVE_BSD_QSORT_R)
      check_symbol_exists(SC_HAVE_BSD_QSORT_R ${PROJECT_BINARY_DIR}/include/sc_config.h SC_have_bsd_qsort_r)
    endif()
  endif()
endif()
