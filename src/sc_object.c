...
void
sc_object_destroy_V (sc_object_t * o)
{
  ...
  oinmi =
    sc_object_method_lookup (s, (sc_void_function_t) sc_object_destroy_V,
                             (void *) o);
...
void
sc_object_print_V (sc_object_t * o, FILE * f)
{
  sc_object_system_t *s = o->s;
  sc_void_function_t  oinmi;

  /* get the implementation of this method for this object */
  oinmi = sc_object_method_lookup (s, (sc_void_function_t) sc_object_print_V,
                                   (void *) o);
