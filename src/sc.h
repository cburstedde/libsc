 ...
 */
SC_NORETURN void SC_ABORTF(SC_PRINTF_FMT const char* fmt, ...) SC_PRINTF_LIKE(1, 2);
void SC_CHECK_ABORTF(int success, SC_PRINTF_FMT const char* fmt, ...) SC_PRINTF_LIKE(2, 3);
...
void                SC_GLOBAL_STATISTICSF (SC_PRINTF_FMT const char *fmt, ...)
  SC_PRINTF_LIKE(1, 2);
void                SC_GLOBAL_PRODUCTIONF (SC_PRINTF_FMT const char *fmt, ...)
  SC_PRINTF_LIKE(1, 2);
 ...
 * \param [in] fmt      Format string as in man (3) snprintf.
 */
